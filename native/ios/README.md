...
| `Sources/Views/*` | Welcome, Overview, Chat (Profile/Stranger/Rooms), Studio (Compose/Posts/Study), Connect (Social/Apps/Robots), Settings |
...
Posts / Study, and **Connect** groups the social-platform connections, the
connected-apps catalog, and robotic embodiment.
