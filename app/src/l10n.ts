...
const CHROME: Table = {
  ...
  "pub.mark.synth": {
    en: "This is synthetic: a profile wrote it, not a human.", es: "Esto es sintético: lo escribió un perfil, no un humano.", fr: "C'est synthétique : un profil l'a écrit, pas un humain.", de: "Das ist synthetisch: ein Profil hat es geschrieben, kein Mensch.", pt: "Isto é sintético: um perfil o escreveu, não um humano.", it: "Questo è sintetico: l'ha scritto un profilo, non un umano.", ja: "これは合成です。人間ではなくプロフィールが書きました。", zh: "这是合成内容：由一个资料所写，而非人类。", hi: "यह सिंथेटिक है: इसे किसी प्रोफ़ाइल ने लिखा, इंसान ने नहीं।", ar: "هذا اصطناعي: كتبه ملف تعريف لا إنسان.",
  },
  "pub.mark.maybehuman": {
    en: "No profile of this deployment wrote this. That is what human writing looks like here — and also what a machine that signs nothing looks like, so absence is not proof.", es: "Ningún perfil de esta instalación escribió esto. Así se ve aquí la escritura humana — y también así se ve una máquina que no firma nada, de modo que la ausencia no es prueba.", fr: "Aucun profil de ce déploiement n'a écrit ceci. C'est à cela que ressemble l'écriture humaine ici — et aussi à cela que ressemble une machine qui ne signe rien, donc l'absence n'est pas une preuve.", de: "Kein Profil dieser Installation hat das geschrieben. So sieht hier menschliches Schreiben aus — und so sieht auch eine Maschine aus, die nichts signiert; Abwesenheit ist also kein Beweis.", pt: "Nenhum perfil desta instalação escreveu isto. É assim que a escrita humana se parece aqui — e também assim se parece uma máquina que não assina nada, portanto a ausência não é prova.", it: "Nessun profilo di questa installazione ha scritto questo. È così che appare qui la scrittura umana — ed è anche così che appare una macchina che non firma nulla, quindi l'assenza non è una prova.", ja: "この配備のどのプロフィールもこれを書いていません。ここでは人間の文章はそう見えます — ただし何も署名しない機械も同じに見えるため、不在は証明にはなりません。", zh: "此部署中没有任何资料写过这段文字。人类写作在这里就是这个样子——但不签名的机器看起来也一样，所以“没有标记”不能作为证明。", hi: "इस परिनियोजन की किसी प्रोफ़ाइल ने यह नहीं लिखा। यहाँ इंसानी लेखन ऐसा ही दिखता है — और जो मशीन कुछ नहीं हस्ताक्षरित करती वह भी ऐसी ही दिखती है, इसलिए अनुपस्थिति प्रमाण नहीं है।", ar: "لم يكتب هذا أيُّ ملف في هذا النشر. هكذا تبدو الكتابة البشرية هنا — وهكذا تبدو أيضًا آلة لا توقّع شيئًا، فالغياب ليس برهانًا.",
  },
  "pub.mark.unknown": {
  ...
  // Coming back to an account that already holds profiles. The screen this
  // sits on used to offer one thing — make a new profile — to somebody whose
  // profiles already existed and whose owner tokens were on a phone or in a
  // reinstalled app.
  "onb.held.title": {
    en: "Already on this account",
    es: "Ya en esta cuenta",
    fr: "Déjà sur ce compte",
    de: "Bereits in diesem Konto",
    pt: "Já nesta conta",
    it: "Già in questo account",
    ja: "このアカウントにあるもの",
    zh: "这个账户里已有的",
    hi: "इस खाते में पहले से",
    ar: "موجود بالفعل في هذا الحساب",
  },
  "onb.held.pitch": {
    en: "Open one instead of starting again. Signing in is enough — you do not need the key you were given when you made it.",
    es: "Abre uno en lugar de empezar de nuevo. Basta con iniciar sesión: no necesitas la clave que te dieron al crearlo.",
    fr: "Ouvrez-en un plutôt que de recommencer. Se connecter suffit : la clé remise à la création n’est pas nécessaire.",
    de: "Öffne eines, statt neu anzufangen. Anmelden genügt — der Schlüssel von damals wird nicht gebraucht.",
    pt: "Abre um em vez de começar de novo. Basta iniciar sessão: não precisas da chave que te deram quando o criaste.",
    it: "Aprine uno invece di ricominciare. Basta accedere: non serve la chiave ricevuta quando l’hai creato.",
    ja: "作り直さず、こちらを開いてください。サインインだけで十分です。作成時に渡された鍵は要りません。",
    zh: "打开已有的，不必重新开始。登录就够了，不需要当初创建时给你的那把钥匙。",
  ...
  "onb.held.none": {
    ...
    fr: "Rien encore sur ce compte. Le formulaire ci-dessous crée le premier.",
    de: "Noch nichts in diesem Konto. Das Formular unten legt das erste an.",
    pt: "Ainda não há nada nesta conta. O formulário abaixo cria o primeiro.",
    it: "Ancora niente in questo account. Il modulo qui sotto crea il primo.",
    ja: "このアカウントにはまだ何もありません。下のフォームで最初のものを作れます。",
    zh: "这个账户里还什么都没有。下面的表单可以创建第一个。",
    hi: "इस खाते में अभी कुछ नहीं है। नीचे का फ़ॉर्म पहला बनाता है।",
    ar: "لا شيء في هذا الحساب بعد. النموذج أدناه يُنشئ الأول.",
  },
  "onb.held.new": {
    en: "Or make another one",
    es: "O crea otro",
    fr: "Ou en créer un autre",
    de: "Oder ein weiteres anlegen",
    pt: "Ou cria outro",
    it: "Oppure creane un altro",
    ja: "または、もうひとつ作る",
    zh: "或者再建一个",
    hi: "या एक और बनाइए",
    ar: "أو أنشئ واحدًا آخر",
  },
  "onb.invite": {
    en: "Invite key",
  ...
  "onb.show.password": {
    ...
    pt: "Mostrar a palavra-passe", it: "Mostrare la password",
    ja: "パスワードを表示", zh: "显示密码",
    hi: "पासवर्ड दिखाएँ", ar: "إظهار كلمة المرور",
  },
  "onb.hide.password": {
    en: "Hide password", es: "Ocultar la contraseña",
    fr: "Masquer le mot de passe", de: "Passwort verbergen",
    pt: "Ocultar a palavra-passe", it: "Nascondere la password",
    ja: "パスワードを非表示", zh: "隐藏密码",
    hi: "पासवर्ड छिपाएँ", ar: "إخفاء كلمة المرور",
  },
  "onb.creating": {
    en: "Creating…", es: "Creando…", fr: "Création…", de: "Wird erstellt…",
    pt: "A criar…", it: "Creazione…", ja: "作成中…", zh: "创建中…",
    hi: "बना रहे हैं…", ar: "جارٍ الإنشاء…",
  },
  "onb.checking": {
  ...
  "onb.signingin": {
    ...
    de: "Anmeldung läuft…", pt: "A iniciar sessão…", it: "Accesso…",
    ja: "サインイン中…", zh: "登录中…", hi: "साइन इन हो रहा है…",
    ar: "جارٍ تسجيل الدخول…",
  },
  "onb.resetting": {
    en: "Resetting…", es: "Restableciendo…", fr: "Réinitialisation…",
    de: "Wird zurückgesetzt…", pt: "A repor…", it: "Reimpostazione…",
    ja: "リセット中…", zh: "重置中…", hi: "रीसेट हो रहा है…",
    ar: "جارٍ إعادة التعيين…",
  },
  "onb.verify.go": {
    en: "Verify & continue", es: "Verificar y continuar",
    fr: "Vérifier et continuer", de: "Bestätigen und fortfahren",
    pt: "Verificar e continuar", it: "Verifica e continua",
    ja: "確認して続ける", zh: "验证并继续",
  ...
  "onb.create.profile": {
    ...
    de: "Mein Profil erstellen", pt: "Criar o meu perfil",
    it: "Crea il mio profilo", ja: "プロフィールを作成",
    zh: "创建我的档案", hi: "मेरी प्रोफ़ाइल बनाएँ",
    ar: "أنشئ ملفي",
  },
  "onb.verify.type": {
  ...
  "asst.worn.scan": {
    en: "Scan for devices", es: "Buscar dispositivos", fr: "Rechercher des appareils", de: "Nach Geräten suchen", pt: "Procurar dispositivos", it: "Cerca dispositivi", ja: "デバイスをスキャン", zh: "扫描设备", hi: "डिवाइस खोजें", ar: "البحث عن الأجهزة",
  },
  "asst.worn.nobt": {
    en: "This browser cannot scan for Bluetooth devices — type the name instead.", es: "Este navegador no puede buscar dispositivos Bluetooth: escribe el nombre.", fr: "Ce navigateur ne peut pas rechercher d'appareils Bluetooth — saisissez le nom.", de: "Dieser Browser kann nicht nach Bluetooth-Geräten suchen — geben Sie den Namen ein.", pt: "Este navegador não consegue procurar dispositivos Bluetooth — escreva o nome.", it: "Questo browser non può cercare dispositivi Bluetooth: scrivi il nome.", ja: "このブラウザはBluetoothデバイスをスキャンできません。名前を入力してください。", zh: "此浏览器无法扫描蓝牙设备——请输入名称。", hi: "यह ब्राउज़र ब्लूटूथ डिवाइस स्कैन नहीं कर सकता — नाम लिखें।", ar: "لا يمكن لهذا المتصفح البحث عن أجهزة بلوتوث — اكتب الاسم بدلاً من ذلك.",
  },
  "asst.worn.refused": {
  ...
  "set.api.lead": {
    en: "This is the address of the QRME backend this console talks to (the desktop app starts its own; a phone points here over Wi-Fi). If the app on your phone cannot reach anything, this is where you fix it: point it at the machine running the backend. It is an address, not a secret — and it is not the model API key below: the two are different things.", es: "Esta es la dirección del backend de QRME con el que habla esta consola (la app de escritorio arranca el suyo; un teléfono apunta aquí por Wi-Fi). Si la app de tu teléfono no llega a nada, aquí es donde se arregla: apúntala a la máquina donde corre el backend. Es una dirección, no un secreto — y no es la clave API del modelo de abajo: son dos cosas distintas.", fr: "C'est l'adresse du backend QRME auquel cette console parle (l'app de bureau démarre le sien ; un téléphone pointe ici par Wi-Fi). Si l'app de votre téléphone n'atteint rien, c'est ici que ça se répare : pointez-la vers la machine qui exécute le backend. C'est une adresse, pas un secret — et ce n'est pas la clé API du modèle ci-dessous : ce sont deux choses différentes.", de: "Dies ist die Adresse des QRME-Backends, mit dem diese Konsole spricht (die Desktop-App startet ihr eigenes; ein Telefon zeigt per WLAN hierher). Wenn die App auf Ihrem Telefon nichts erreicht, wird es hier behoben: auf die Maschine zeigen, auf der das Backend läuft. Es ist eine Adresse, kein Geheimnis — und nicht der Modell-API-Schlüssel unten: das sind zwei verschiedene Dinge.", pt: "Este é o endereço do backend QRME com que esta consola fala (a app de desktop arranca o seu; um telemóvel aponta aqui por Wi-Fi). Se a app no seu telemóvel não chega a nada, é aqui que se conserta: aponte-a para a máquina onde corre o backend. É um endereço, não um segredo — e não é a chave API do modelo abaixo: são coisas diferentes.", it: "Questo è l'indirizzo del backend QRME con cui parla questa console (l'app desktop avvia il suo; un telefono punta qui via Wi-Fi). Se l'app sul tuo telefono non raggiunge nulla, si sistema qui: puntala alla macchina su cui gira il backend. È un indirizzo, non un segreto — e non è la chiave API del modello qui sotto: sono due cose diverse.", ja: "これはこのコンソールが話すQRMEバックエンドのアドレスです（デスクトップアプリは自前で起動し、スマホはWi-Fi経由でここを指します）。スマホのアプリがどこにもつながらないときは、ここで直します — バックエンドが動いている機械に向けてください。これはアドレスであり秘密ではなく、下のモデルAPIキーとも別物です。", zh: "这是本控制台连接的QRME后端地址（桌面应用自行启动；手机通过Wi-Fi指向这里）。如果手机上的应用什么都连不上，就在这里修：把它指向运行后端的机器。它是地址而非机密 — 也不是下方的模型API密钥：两者是不同的东西。", hi: "यह उस QRME बैकएंड का पता है जिससे यह कंसोल बात करती है (डेस्कटॉप ऐप अपना खुद चलाता है; फ़ोन Wi-Fi से यहाँ इंगित करता है)। अगर आपके फ़ोन का ऐप कहीं नहीं पहुँच पा रहा, तो ठीक यहीं ठीक होता है: इसे उस मशीन की ओर करें जिस पर बैकएंड चल रहा है। यह पता है, रहस्य नहीं — और नीचे वाली मॉडल API कुंजी नहीं है: दोनों अलग चीज़ें हैं।", ar: "هذا عنوان خادم QRME الذي تتحدث إليه هذه الوحدة (تطبيق سطح المكتب يشغّل خادمه؛ والهاتف يشير هنا عبر Wi-Fi). إن لم يصل تطبيق هاتفك إلى شيء، فهنا يُصلَح الأمر: وجّهه إلى الجهاز الذي يعمل عليه الخادم. إنه عنوان لا سر — وليس مفتاح API النموذج أدناه: هما شيئان مختلفان.",
  },
  "set.api.url": {
  ...
  "set.offline.on": {
    en: "Offline mode is on: nothing leaves this machine, and the cloud is refused outright.", es: "El modo sin conexión está activado: nada sale de esta máquina y la nube se rechaza de plano.", fr: "Le mode hors ligne est activé : rien ne quitte cette machine et le cloud est refusé d'emblée.", de: "Der Offline-Modus ist an: nichts verlässt diese Maschine, und die Cloud wird rundweg abgelehnt.", pt: "O modo offline está ligado: nada sai desta máquina e a nuvem é recusada à partida.", it: "La modalità offline è attiva: niente lascia questa macchina e il cloud viene rifiutato in blocco.", ja: "オフラインモードが有効です。この機械から何も出ず、クラウドは端から拒否されます。", zh: "离线模式已开启：任何内容都不会离开这台机器，云端被直接拒绝。", hi: "ऑफ़लाइन मोड चालू है: इस मशीन से कुछ बाहर नहीं जाता, और क्लाउड को सिरे से मना किया जाता है।", ar: "وضع عدم الاتصال مفعّل: لا شيء يغادر هذه الآلة، والسحابة مرفوضة رفضًا تامًا.",
  },
  "set.offline.off": {
    en: "Running normally: inference stays local unless you attach a cloud model, and cloud use is opt-in.", es: "Funcionando con normalidad: la inferencia se queda local salvo que conectes un modelo en la nube, y usar la nube es opcional.", fr: "Fonctionnement normal : l'inférence reste locale sauf si vous attachez un modèle cloud, et l'usage du cloud est volontaire.", de: "Normaler Betrieb: die Inferenz bleibt lokal, sofern Sie kein Cloud-Modell anbinden, und Cloud-Nutzung ist opt-in.", pt: "A funcionar normalmente: a inferência fica local a menos que ligue um modelo na nuvem, e o uso da nuvem é opcional.", it: "Funzionamento normale: l'inferenza resta locale a meno che tu non colleghi un modello cloud, e l'uso del cloud è una scelta.", ja: "通常どおり動作中です。クラウドモデルを接続しない限り推論はローカルにとどまり、クラウド利用はオプトインです。", zh: "正常运行：除非你接入云端模型，推理都留在本地，云端使用需自行选择。", hi: "सामान्य रूप से चल रहा है: जब तक आप क्लाउड मॉडल न जोड़ें, अनुमान स्थानीय ही रहता है, और क्लाउड उपयोग वैकल्पिक है।", ar: "يعمل بشكل طبيعي: يبقى الاستدلال محليًا ما لم توصل نموذجًا سحابيًا، واستخدام السحابة اختياري.",
  },
  "set.export": {
    en: "Everything it is made of", es: "Todo aquello de lo que está hecho", fr: "Tout ce dont il est fait", de: "Alles, woraus es besteht", pt: "Tudo aquilo de que é feito", it: "Tutto ciò di cui è fatto", ja: "この分身を成すすべて", zh: "构成它的一切", hi: "जिससे यह बना है, वह सब", ar: "كل ما هو مصنوع منه",
  },
  "set.export.pitch": {
    en: "Your profile's full record — persona, sources, memories — as one document on your clipboard. It is your material: feed it to a model you are training, keep it, move it. Nothing is sent anywhere by copying it.", es: "El registro completo de tu perfil — persona, fuentes, recuerdos — como un solo documento en tu portapapeles. Es tu material: dáselo a un modelo que estés entrenando, guárdalo, muévelo. Copiarlo no envía nada a ninguna parte.", fr: "Le dossier complet de votre profil — persona, sources, souvenirs — en un seul document dans votre presse-papiers. C'est votre matière : donnez-la à un modèle que vous entraînez, gardez-la, déplacez-la. Le copier n'envoie rien nulle part.", de: "Der vollständige Datensatz Ihres Profils — Persona, Quellen, Erinnerungen — als ein Dokument in Ihrer Zwischenablage. Es ist Ihr Material: geben Sie es einem Modell, das Sie trainieren, behalten Sie es, nehmen Sie es mit. Beim Kopieren wird nichts irgendwohin gesendet.", pt: "O registo completo do seu perfil — persona, fontes, memórias — como um só documento na sua área de transferência. É material seu: dê-o a um modelo que esteja a treinar, guarde-o, leve-o. Copiá-lo não envia nada para lado nenhum.", it: "Il fascicolo completo del tuo profilo — persona, fonti, ricordi — come un unico documento negli appunti. È materiale tuo: dallo a un modello che stai addestrando, conservalo, portalo via. Copiarlo non invia nulla da nessuna parte.", ja: "プロフィールの全記録 — 人格、素材、記憶 — を一つの文書としてクリップボードへ。これはあなたの資料です。訓練中のモデルに与えるも、保管するも、持ち出すも自由です。コピーしても、どこにも送信されません。", zh: "你的资料的完整记录——人格、素材、记忆——作为一份文档复制到剪贴板。这是你的材料：喂给你在训练的模型、留存、迁移都可以。复制不会向任何地方发送任何内容。", hi: "आपकी प्रोफ़ाइल का पूरा रिकॉर्ड — व्यक्तित्व, स्रोत, यादें — एक दस्तावेज़ के रूप में आपके क्लिपबोर्ड पर। यह आपकी सामग्री है: इसे अपने प्रशिक्षित हो रहे मॉडल को दें, रखें, ले जाएँ। कॉपी करने से कहीं कुछ नहीं भेजा जाता।", ar: "سجل ملفك الكامل — الشخصية والمصادر والذكريات — كوثيقة واحدة في حافظتك. إنها مادتك: أعطها لنموذج تدرّبه، احتفظ بها، انقلها. نسخها لا يرسل شيئًا إلى أي مكان.",
  },
  "set.export.copy": {
    en: "Copy it all", es: "Copiarlo todo", fr: "Tout copier", de: "Alles kopieren", pt: "Copiar tudo", it: "Copia tutto", ja: "すべてコピー", zh: "全部复制", hi: "सब कॉपी करें", ar: "انسخ الكل",
  },
  ...
  "rem.apps.all": {
    en: "All of the above", es: "Todo lo anterior", fr: "Tout ce qui précède", de: "Alle oben genannten", pt: "Tudo o que está acima", it: "Tutti quelli sopra", ja: "上記すべて", zh: "以上全部", hi: "उपरोक्त सभी", ar: "كل ما سبق",
  },
  "rem.apps.connected": {
  ...
  "rem.trip.pitch": {
    en: "Give it a topic and a question, and it goes to find out — the findings appear right below and can be folded into what it knows. Private names are stripped from the question before it leaves, and the answer says whether anything left this machine at all.", es: "Dale un tema y una pregunta, y va a averiguarlo — los hallazgos aparecen justo debajo y pueden incorporarse a lo que sabe. Los nombres privados se quitan de la pregunta antes de salir, y la respuesta dice si algo llegó a salir de esta máquina.", fr: "Donnez-lui un sujet et une question, et il va se renseigner — les résultats s'affichent juste en dessous et peuvent être intégrés à ce qu'il sait. Les noms privés sont retirés de la question avant qu'elle parte, et la réponse dit si quoi que ce soit a quitté cette machine.", de: "Geben Sie ihm ein Thema und eine Frage, und es zieht los — die Befunde erscheinen direkt darunter und lassen sich in sein Wissen einarbeiten. Private Namen werden vor dem Absenden aus der Frage entfernt, und die Antwort sagt, ob überhaupt etwas diese Maschine verließ.", pt: "Dê-lhe um tema e uma pergunta, e ele vai descobrir — os resultados aparecem logo abaixo e podem ser incorporados no que ele sabe. Nomes privados são retirados da pergunta antes de sair, e a resposta diz se algo chegou a sair desta máquina.", it: "Dagli un tema e una domanda, e va a informarsi — i risultati compaiono qui sotto e possono confluire in ciò che sa. I nomi privati vengono tolti dalla domanda prima che parta, e la risposta dice se qualcosa ha mai lasciato questa macchina.", ja: "テーマと質問を渡すと、調べに行きます — 結果はすぐ下に現れ、知識に取り込めます。個人の名前は質問が出る前に取り除かれ、答えには、そもそも何かがこの機械を出たのかが書かれます。", zh: "给它一个主题和一个问题，它就去查——结果就显示在下方，并可并入它的知识。私人名字会在问题发出前被剥除，答案会说明是否有任何内容离开了这台机器。", hi: "इसे एक विषय और एक प्रश्न दें, और यह पता लगाने जाता है — निष्कर्ष ठीक नीचे दिखते हैं और इसकी जानकारी में जोड़े जा सकते हैं। निजी नाम प्रश्न के निकलने से पहले हटा दिए जाते हैं, और उत्तर बताता है कि कुछ इस मशीन से बाहर गया भी या नहीं।", ar: "أعطه موضوعًا وسؤالًا فيذهب ليستقصي — تظهر النتائج أدناه مباشرة ويمكن ضمّها إلى معرفته. تُحذف الأسماء الخاصة من السؤال قبل أن يغادر، ويقول الجواب هل غادر أي شيء هذه الآلة أصلًا.",
  },
  "prob.server": {
    en: "What has reached the server", es: "Lo que ha llegado al servidor", fr: "Ce qui a atteint le serveur", de: "Was den Server erreicht hat", pt: "O que chegou ao servidor", it: "Cosa è arrivato al server", ja: "サーバーに届いたもの", zh: "已到达服务器的内容", hi: "सर्वर तक क्या पहुँचा", ar: "ما وصل إلى الخادم",
  },
  "prob.server.pitch": {
  ...
  "prob.none": {
    en: "Nothing has been reported to this server yet.", es: "Aún no se ha informado nada a este servidor.", fr: "Rien n'a encore été rapporté à ce serveur.", de: "Diesem Server wurde noch nichts gemeldet.", pt: "Ainda nada foi comunicado a este servidor.", it: "A questo server non è ancora stato segnalato nulla.", ja: "このサーバーにはまだ何も報告されていません。", zh: "尚未有任何报告到达此服务器。", hi: "इस सर्वर को अभी तक कुछ नहीं बताया गया।", ar: "لم يُبلَّغ هذا الخادم بشيء بعد.",
  },
  "rem.trip.back": {
    en: "It came back — the findings are right below.", es: "Ya volvió: los hallazgos están justo debajo.", fr: "Il est revenu — les résultats sont juste en dessous.", de: "Es ist zurück — die Befunde stehen direkt darunter.", pt: "Já voltou — os resultados estão logo abaixo.", it: "È tornato: i risultati sono qui sotto.", ja: "戻ってきました — 結果はすぐ下にあります。", zh: "它回来了——结果就在下方。", hi: "यह लौट आया — निष्कर्ष ठीक नीचे हैं।", ar: "لقد عاد — النتائج أدناه مباشرة.",
  },
  "rem.trip.topic.ph": {
  ...
  "rem.look.id.ph": {
    en: "paste the record's id, from wherever it is shown", es: "pega el id del registro, de dondequiera que se muestre", fr: "collez l'identifiant de l'enregistrement, où qu'il s'affiche", de: "die ID des Eintrags einfügen, von wo auch immer sie steht", pt: "cole o id do registo, de onde quer que apareça", it: "incolla l'id del record, da ovunque sia mostrato", ja: "その記録のIDを、表示されている所から貼り付け", zh: "粘贴该记录的 id，无论它显示在哪里", hi: "रिकॉर्ड की आईडी चिपकाएँ, जहाँ भी दिखे", ar: "الصق معرّف السجل من حيثما يظهر",
  },
  "rem.look.go": {
  ...
  "rem.avatar.asset.ph": {
    en: "or paste an uploaded picture's link", es: "o pega el enlace de una imagen subida", fr: "ou collez le lien d'une image téléversée", de: "oder den Link eines hochgeladenen Bilds einfügen", pt: "ou cole o link de uma imagem carregada", it: "oppure incolla il link di un'immagine caricata", ja: "またはアップロード済み画像のリンクを貼り付け", zh: "或粘贴已上传图片的链接", hi: "या अपलोड की गई तस्वीर का लिंक चिपकाएँ", ar: "أو الصق رابط صورة مرفوعة",
  },
  "rem.avatar.upload": {
    en: "Upload a picture or video", es: "Subir una imagen o un vídeo", fr: "Téléverser une image ou une vidéo", de: "Bild oder Video hochladen", pt: "Carregar uma imagem ou um vídeo", it: "Carica un'immagine o un video", ja: "画像または動画をアップロード", zh: "上传图片或视频", hi: "तस्वीर या वीडियो अपलोड करें", ar: "ارفع صورة أو مقطع فيديو",
  },
  "rem.avatar.done": {
    en: "Portrait set.", es: "Retrato fijado.", fr: "Portrait défini.", de: "Porträt gesetzt.", pt: "Retrato definido.", it: "Ritratto impostato.", ja: "肖像を設定しました。", zh: "已设置肖像。", hi: "चित्र लग गया।", ar: "تم تعيين الصورة.",
  },
  "rem.avatar.set": {
  ...
  "wsh.spec.pick": {
    en: "Pick the profile that knows more…", es: "Elige el perfil que sabe más…", fr: "Choisissez le profil qui en sait plus…", de: "Wählen Sie das Profil, das mehr weiß…", pt: "Escolha o perfil que sabe mais…", it: "Scegli il profilo che ne sa di più…", ja: "詳しいプロフィールを選択…", zh: "选择更懂行的档案…", hi: "वह प्रोफ़ाइल चुनें जो अधिक जानती है…", ar: "اختر الملف الذي يعرف أكثر…",
  },
  "wsh.knows.files": {
    en: "Upload files as material", es: "Subir archivos como material", fr: "Téléverser des fichiers comme matériel", de: "Dateien als Material hochladen", pt: "Enviar arquivos como material", it: "Carica file come materiale", ja: "ファイルを素材としてアップロード", zh: "上传文件作为素材", hi: "फ़ाइलें सामग्री के रूप में अपलोड करें", ar: "ارفع ملفات كمواد",
  },
  "wsh.see.photo": {
    en: "Take or upload a photo", es: "Tomar o subir una foto", fr: "Prendre ou téléverser une photo", de: "Foto aufnehmen oder hochladen", pt: "Tirar ou enviar uma foto", it: "Scatta o carica una foto", ja: "写真を撮るかアップロード", zh: "拍照或上传照片", hi: "फ़ोटो लें या अपलोड करें", ar: "التقط صورة أو ارفعها",
  },
  "wsh.fold": {
    en: "Re-learn who it is", es: "Reaprender quién es", fr: "Réapprendre qui il est", de: "Neu lernen, wer es ist", pt: "Reaprender quem é", it: "Reimparare chi è", ja: "自分が誰かを学び直す", zh: "重新学习它是谁", hi: "फिर से सीखे कि यह कौन है", ar: "يتعلم من جديد من هو",
  },
  "wsh.fold.pitch": {
    en: "Press this after adding or changing material above. The profile re-reads everything it is made of and rebuilds how it speaks and what it remembers — nothing is sent anywhere.", es: "Pulsa esto después de añadir o cambiar material arriba. El perfil relee todo de lo que está hecho y reconstruye cómo habla y qué recuerda — nada se envía a ninguna parte.", fr: "Appuyez ici après avoir ajouté ou modifié du matériel ci-dessus. Le profil relit tout ce qui le compose et reconstruit sa façon de parler et ce dont il se souvient — rien n'est envoyé nulle part.", de: "Drücken Sie dies, nachdem Sie oben Material hinzugefügt oder geändert haben. Das Profil liest alles neu, woraus es besteht, und baut neu auf, wie es spricht und was es erinnert — nichts wird irgendwohin gesendet.", pt: "Pressione isto depois de adicionar ou alterar material acima. O perfil relê tudo de que é feito e reconstrói como fala e o que lembra — nada é enviado a lugar nenhum.", it: "Premi qui dopo aver aggiunto o cambiato materiale sopra. Il profilo rilegge tutto ciò di cui è fatto e ricostruisce come parla e cosa ricorda — nulla viene inviato da nessuna parte.", ja: "上で素材を追加・変更したらこれを押してください。プロフィールは自分を成すすべてを読み直し、話し方と記憶を組み立て直します — どこにも何も送信されません。", zh: "在上方添加或更改素材后按这里。档案会重新读取构成它的一切，重建它的说话方式和记忆 — 不会向任何地方发送任何内容。", hi: "ऊपर सामग्री जोड़ने या बदलने के बाद इसे दबाएँ। प्रोफ़ाइल अपनी हर चीज़ फिर पढ़ती है और बोलने का ढंग व यादें फिर बनाती है — कहीं कुछ नहीं भेजा जाता।", ar: "اضغط هذا بعد إضافة أو تغيير المواد أعلاه. يعيد الملف قراءة كل ما يتكوّن منه ويعيد بناء طريقة كلامه وما يتذكره — لا يُرسل شيء إلى أي مكان.",
  },
  "wsh.fold.run": {
  ...
  "rch.pick": {
    en: "Someone it knows…", es: "Alguien que conoce…", fr: "Quelqu'un qu'il connaît…", de: "Jemand, den es kennt…", pt: "Alguém que ele conhece…", it: "Qualcuno che conosce…", ja: "知っている相手…", zh: "它认识的人…", hi: "जिसे यह जानता है…", ar: "شخص يعرفه…",
  },
  "rch.pickfirst": {
    en: "Pick a person first — the list is everyone this profile has talked to, and every button on this screen is about one of them.", es: "Elige primero a una persona — la lista es todos con quienes este perfil ha hablado, y cada botón de esta pantalla trata de uno de ellos.", fr: "Choisissez d'abord une personne — la liste regroupe tous ceux à qui ce profil a parlé, et chaque bouton de cet écran concerne l'un d'eux.", de: "Wählen Sie zuerst eine Person — die Liste sind alle, mit denen dieses Profil gesprochen hat, und jede Schaltfläche auf diesem Bildschirm betrifft eine von ihnen.", pt: "Escolha primeiro uma pessoa — a lista é todos com quem este perfil falou, e cada botão desta tela é sobre um deles.", it: "Scegli prima una persona — l'elenco è chiunque abbia parlato con questo profilo, e ogni pulsante di questa schermata riguarda uno di loro.", ja: "まず相手を選んでください — 一覧はこのプロフィールが話したことのある全員で、この画面のボタンはすべてその相手についてのものです。", zh: "请先选择一个人 — 列表是这个档案聊过的所有人，本屏幕上的每个按钮都是关于其中一位的。", hi: "पहले एक व्यक्ति चुनें — सूची में वे सब हैं जिनसे इस प्रोफ़ाइल ने बात की है, और इस स्क्रीन का हर बटन उन्हीं में से किसी एक के बारे में है।", ar: "اختر شخصًا أولًا — القائمة هي كل من تحدث معه هذا الملف، وكل زر في هذه الشاشة يخص أحدهم.",
  },
  "rch.how": {
  ...
  "vis.where.ph": {
    en: "the place the sticker will sit — a bench, a counter, a meeting", es: "el lugar donde estará la pegatina: un banco, un mostrador, una reunión", fr: "l'endroit où sera l'autocollant — un banc, un comptoir, une réunion", de: "wo der Aufkleber sitzen wird — eine Bank, ein Tresen, ein Treffen", pt: "o lugar onde o autocolante vai ficar — um banco, um balcão, uma reunião", it: "il posto dove starà l'adesivo — una panchina, un bancone, un incontro", ja: "ステッカーを置く場所 — ベンチ、カウンター、集まりの場", zh: "贴纸将放置的地方——长椅、柜台、聚会现场", hi: "स्टिकर कहाँ रहेगा — बेंच, काउंटर, बैठक", ar: "المكان الذي سيوضع فيه الملصق — مقعد، طاولة، اجتماع",
  },
  "vis.mode.chat": {
  ...
  "nmd.campaign.ph": {
    en: "paste the campaign's id — it is on the campaign's own page", es: "pega el id de la campaña: está en la propia página de la campaña", fr: "collez l'identifiant de la campagne — il figure sur sa propre page", de: "die ID der Kampagne einfügen — sie steht auf deren eigener Seite", pt: "cole o id da campanha — está na própria página da campanha", it: "incolla l'id della campagna: è sulla sua stessa pagina", ja: "キャンペーンのIDを貼り付け — キャンペーン自身のページにあります", zh: "粘贴活动的 id——就在活动自己的页面上", hi: "अभियान की आईडी चिपकाएँ — यह अभियान के अपने पृष्ठ पर है", ar: "الصق معرّف الحملة — تجده على صفحة الحملة نفسها",
  },
  "nmd.lookitup": {
  ...
  "nmd.org.ph": {
    en: "paste the organization's id — from its record or an invite", es: "pega el id de la organización: de su ficha o de una invitación", fr: "collez l'identifiant de l'organisation — depuis sa fiche ou une invitation", de: "die ID der Organisation einfügen — aus ihrem Eintrag oder einer Einladung", pt: "cole o id da organização — da sua ficha ou de um convite", it: "incolla l'id dell'organizzazione: dalla sua scheda o da un invito", ja: "組織のIDを貼り付け — その記録か招待にあります", zh: "粘贴组织的 id——来自它的记录或邀请", hi: "संगठन की आईडी चिपकाएँ — उसके रिकॉर्ड या निमंत्रण से", ar: "الصق معرّف المنظمة — من سجلّها أو من دعوة",
  },
  "nmd.nodepts": {
  ...
  "nmd.excursion.ph": {
    en: "paste the trip's id — every excursion lists one", es: "pega el id de la salida: cada excursión muestra uno", fr: "collez l'identifiant de la sortie — chaque excursion en affiche un", de: "die ID des Ausflugs einfügen — jeder Ausflug nennt eine", pt: "cole o id da saída — cada excursão mostra um", it: "incolla l'id dell'uscita: ogni escursione ne elenca uno", ja: "調べ物のIDを貼り付け — どの外出調査にも記載があります", zh: "粘贴此行的 id——每次外出查询都会列出一个", hi: "यात्रा की आईडी चिपकाएँ — हर बाहरी खोज एक दिखाती है", ar: "الصق معرّف الرحلة — كل رحلة تعرض واحدًا",
  },
  "nmd.leftmachine": {
  ...
  "nmd.lending.pitch": {
    en: "A skill can be lent to somebody for one place — a desk, a room, an exchange — without being installed on their account. This lists what you are lending out and what you are borrowing.", es: "Una habilidad puede prestarse a alguien para un solo lugar — un escritorio, una sala, un intercambio — sin instalarse en su cuenta. Aquí se listan las que prestas y las que tomas prestadas.", fr: "Une compétence peut être prêtée à quelqu'un pour un seul lieu — un bureau, un salon, un échange — sans être installée sur son compte. Voici ce que vous prêtez et ce que vous empruntez.", de: "Eine Fähigkeit kann jemandem für einen Ort geliehen werden — einen Schreibtisch, einen Raum, einen Austausch — ohne auf seinem Konto installiert zu werden. Hier steht, was Sie verleihen und was Sie borgen.", pt: "Uma competência pode ser emprestada a alguém para um só lugar — uma secretária, uma sala, uma troca — sem ser instalada na conta dessa pessoa. Aqui está o que empresta e o que pede emprestado.", it: "Un'abilità può essere prestata a qualcuno per un solo luogo — una scrivania, una stanza, uno scambio — senza essere installata sul suo account. Qui c'è ciò che presti e ciò che prendi in prestito.", ja: "スキルは、相手のアカウントにインストールされることなく、一つの場所 — デスク、ルーム、交換 — に限って貸し出せます。ここには貸しているものと借りているものが並びます。", zh: "技能可以只为一个场所——桌台、房间、交换——借给某人，而不会安装到对方的账户上。这里列出你借出的和借入的。", hi: "कोई कौशल किसी को एक ही जगह के लिए — डेस्क, कक्ष, विनिमय — उधार दिया जा सकता है, उनके खाते में स्थापित हुए बिना। यहाँ वह है जो आप उधार दे रहे हैं और जो ले रहे हैं।", ar: "يمكن إعارة مهارة لشخص في مكان واحد فقط — مكتب، غرفة، تبادل — دون تثبيتها في حسابه. هنا ما تعيره وما تستعيره.",
  },
  "nmd.nogrants": {
    en: "Nothing lent, nothing borrowed right now.", es: "Nada prestado ni tomado prestado por ahora.", fr: "Rien de prêté ni d'emprunté pour l'instant.", de: "Zurzeit nichts verliehen und nichts geborgt.", pt: "Nada emprestado nem pedido emprestado por agora.", it: "Niente in prestito, in nessuna direzione, per ora.", ja: "今は貸しているものも借りているものもありません。", zh: "目前没有借出也没有借入。", hi: "अभी न कुछ उधार दिया है, न लिया है।", ar: "لا شيء مُعار ولا مُستعار حاليًا.",
  },
  "nmd.lending.out": {
    en: "Lending out", es: "Prestando", fr: "En prêt", de: "Verliehen", pt: "A emprestar", it: "In prestito ad altri", ja: "貸し出し中", zh: "借出中", hi: "उधार दिए हुए", ar: "مُعار",
  },
  "nmd.borrowing": {
    en: "Borrowing", es: "Tomado prestado", fr: "Emprunté", de: "Geborgt", pt: "Emprestado a si", it: "Preso in prestito", ja: "借用中", zh: "借入中", hi: "उधार लिए हुए", ar: "مُستعار",
  },
  "nmd.lights.why": {
    en: "Elsewhere in the console, agents and tasks carry a small colored light. This is that light's legend — the smallest lookup here, and the only one anybody may ask.", es: "En otras partes de la consola, los agentes y las tareas llevan una pequeña luz de color. Esta es la leyenda de esa luz: la consulta más pequeña de aquí, y la única que cualquiera puede hacer.", fr: "Ailleurs dans la console, les agents et les tâches portent un petit voyant coloré. Voici la légende de ce voyant — la plus petite consultation ici, et la seule ouverte à tous.", de: "Anderswo in der Konsole tragen Agenten und Aufgaben ein kleines farbiges Licht. Dies ist die Legende dieses Lichts — die kleinste Abfrage hier, und die einzige, die jeder stellen darf.", pt: "Noutras partes da consola, agentes e tarefas trazem uma pequena luz colorida. Esta é a legenda dessa luz — a consulta mais pequena daqui, e a única que qualquer pessoa pode fazer.", it: "Altrove nella console, agenti e attività portano una piccola luce colorata. Questa è la legenda di quella luce: la ricerca più piccola qui, e l'unica aperta a chiunque.", ja: "コンソールの他の画面では、エージェントやタスクに小さな色付きライトが付いています。これはそのライトの凡例です — ここで一番小さな照会であり、誰でも尋ねられる唯一のものです。", zh: "在控制台的其他地方，代理和任务旁都有一盏小彩灯。这就是那盏灯的图例——这里最小的查询，也是唯一人人可问的。", hi: "कंसोल में अन्यत्र, एजेंटों और कार्यों के साथ एक छोटी रंगीन बत्ती दिखती है। यह उसी बत्ती की कुंजी है — यहाँ की सबसे छोटी जानकारी, और अकेली जो कोई भी पूछ सकता है।", ar: "في مواضع أخرى من وحدة التحكم، يحمل الوكلاء والمهام ضوءًا ملوّنًا صغيرًا. هذه هي مفتاح ذلك الضوء — أصغر استعلام هنا، والوحيد المتاح للجميع.",
  },
  "nmd.yoursonly": {
  ...
  "nmd.place.ph": {
    en: "paste the id of the room, profile, org or session", es: "pega el id de la sala, el perfil, la organización o la sesión", fr: "collez l'identifiant du salon, du profil, de l'organisation ou de la session", de: "die ID des Raums, Profils, der Organisation oder Sitzung einfügen", pt: "cole o id da sala, do perfil, da organização ou da sessão", it: "incolla l'id della stanza, del profilo, dell'organizzazione o della sessione", ja: "ルーム・プロフィール・組織・セッションのIDを貼り付け", zh: "粘贴房间、资料、组织或会话的 id", hi: "कक्ष, प्रोफ़ाइल, संगठन या सत्र की आईडी चिपकाएँ", ar: "الصق معرّف الغرفة أو الملف أو المنظمة أو الجلسة",
  },
  "nmd.look": {
    en: "Look", es: "Mirar", fr: "Regarder", de: "Ansehen", pt: "Ver", it: "Guarda", ja: "見る", zh: "查看", hi: "देखें", ar: "انظر",
  },
  ...
  "idn.motion": {
    en: "How it moves:", es: "Cómo se mueve:", fr: "Comment il bouge :", de: "Wie es sich bewegt:", pt: "Como se move:", it: "Come si muove:", ja: "動き方：", zh: "它如何动：", hi: "यह कैसे चलता है:", ar: "كيف يتحرك:",
  },
  "idn.motion.note": {
    en: "The animation itself follows the interaction history — this only picks the style. The badge travels with the movement.", es: "La animación sigue el historial de interacción — aquí solo se elige el estilo. La insignia viaja con el movimiento.", fr: "L'animation suit l'historique d'interaction — ici on ne choisit que le style. Le badge voyage avec le mouvement.", de: "Die Animation folgt der Interaktionsgeschichte — hier wird nur der Stil gewählt. Das Abzeichen reist mit der Bewegung.", pt: "A animação segue o histórico de interação — aqui só se escolhe o estilo. O selo viaja com o movimento.", it: "L'animazione segue la cronologia delle interazioni — qui si sceglie solo lo stile. Il distintivo viaggia con il movimento.", ja: "アニメーションはやり取りの履歴に従います — ここで選ぶのはスタイルだけ。バッジは動きと一緒に運ばれます。", zh: "动画本身跟随互动历史 — 这里只挑样式。徽标随动态一同呈现。", hi: "एनिमेशन स्वयं संवाद इतिहास का अनुसरण करता है — यहाँ केवल शैली चुनी जाती है। बैज गति के साथ चलता है।", ar: "الحركة نفسها تتبع تاريخ التفاعل — هنا يُختار الأسلوب فقط. والشارة تسافر مع الحركة.",
  },
  ...
  "hom.curate": {
    en: "✂️ Curate the transcript", es: "✂️ Curar la transcripción", fr: "✂️ Élaguer la transcription", de: "✂️ Das Protokoll kuratieren", pt: "✂️ Curar a transcrição", it: "✂️ Cura la trascrizione", ja: "✂️ 会話記録を手入れする", zh: "✂️ 整理对话记录", hi: "✂️ प्रतिलिपि सँवारें", ar: "✂️ نقّح المحضر",
  },
  "hom.exportqr": {
    en: "🎫 Take it with you by QR", es: "🎫 Llévatelo por QR", fr: "🎫 Emportez-le par QR", de: "🎫 Per QR mitnehmen", pt: "🎫 Leve-o consigo por QR", it: "🎫 Portalo con te via QR", ja: "🎫 QRで持ち出す", zh: "🎫 用二维码带走", hi: "🎫 QR से साथ ले जाएँ", ar: "🎫 خذه معك عبر QR",
  },
  "hom.roomscene": {
    en: "🎬 Rooms are scenes now", es: "🎬 Las salas ya son escenas", fr: "🎬 Les salons sont des scènes", de: "🎬 Räume sind jetzt Szenen", pt: "🎬 As salas agora são cenas", it: "🎬 Le stanze ora sono scene", ja: "🎬 ルームがシーンになりました", zh: "🎬 房间现在是场景", hi: "🎬 कक्ष अब दृश्य हैं", ar: "🎬 الغرف الآن مشاهد",
  },
  "hom.roulette": {
