...
DIRECTIONS: dict[str, tuple[str, ...]] = {
    ...
    "dock": ("edge dock", "the tabs on the side", "stoplight", "agent lights",
             "watch face", "which agent is stuck", "which agent is running",
             "which agent stopped", "move the tabs", "help tab", "the round window"),
    "company": ("found a company", "start a business", "digital company",
                "hire an employee", "synthetic employees", "staff my store",
                "open for business", "my storefront"),
    "positions": ("what jobs are there", "browse the positions",
                  "list of jobs", "find a job title", "what can i hire",
                  "search for a role", "download knowledge",
                  "what does this job need", "skills for the job",
                  "who does it need to reach"),
    "kit": ("give it a robot", "add a robot", "give it a body",
            "give it a face", "give it eyes", "give it ears",
            "put it on a screen", "add a speaker", "add an earpiece",
            "equip a new hire", "kit them out"),
    ...
    "named": ("what do the lights mean", "green amber red", "the legend",
              ...
              "who is lending what"),
    "lastdoor": ("call an ambulance", "emergency", "999", "911",
                 "reach emergency services", "the waiver", "will it charge me",
                 "did it actually call", "why did nothing happen",
                 "it could not resolve it"),
    "bringreal": ("bring in a real person", "hand it to my doctor",
                  "my butcher", "my broker", "my own people",
                  "give it to a professional", "catch them up",
                  "what will they see", "send my file to somebody"),
    "goingback": ("where has my agent been", "what sites does it visit",
                  "who is tracking me", "stop visiting a site",
                  "block a host", "how often does it go there",
                  "where does this deployment go", "am i being profiled"),
    "maydo": ("what can it do", "what is it allowed to do", "permissions",
              "what am i agreeing to", "turn that off", "stop it doing that",
              "what does it keep", "why can it do that", "what it may do",
