...
_REFUSALS: dict[str, dict[str, str]] = {
    ...
    'that is not a region this product offers a menu for': {
        'es': 'esa no es una región para la que este producto ofrece un menú',
        'fr': "ce n'est pas une région pour laquelle ce produit propose un menu",
        'de': 'das ist keine Region, für die dieses Produkt ein Menü anbietet',
        'pt': 'essa não é uma região para a qual este produto oferece um menu',
        'it': 'quella non è una regione per cui questo prodotto offre un menu',
        'ja': 'この製品がメニューを提供している地域ではありません',
        'zh': '本产品未为该地区提供菜单',
        'hi': 'यह ऐसा क्षेत्र नहीं है जिसके लिए यह उत्पाद मेन्यू देता है',
        'ar': 'هذه ليست منطقة يقدّم لها هذا المنتج قائمة',
    },
    'no such mail thread': {
        'es': 'no existe ese hilo de correo',
        'fr': "ce fil de courrier n'existe pas",
        'de': 'diesen Mailverlauf gibt es nicht',
        'pt': 'não existe esse tópico de correio',
        'it': 'nessuna conversazione di posta con quel nome',
        'ja': 'そのメールスレッドはありません',
        'zh': '没有这个邮件会话',
        'hi': 'ऐसा कोई मेल थ्रेड नहीं',
        'ar': 'لا يوجد مسار بريد بهذا الاسم',
    },
    'no such mail message': {
        'es': 'no existe ese mensaje de correo',
        'fr': "ce message de courrier n'existe pas",
        'de': 'diese Mailnachricht gibt es nicht',
        'pt': 'não existe essa mensagem de correio',
        'it': 'nessun messaggio di posta con quel nome',
        'ja': 'そのメールメッセージはありません',
        'zh': '没有这封邮件',
        'hi': 'ऐसा कोई मेल संदेश नहीं',
        'ar': 'لا توجد رسالة بريد بهذا الاسم',
    },
    'an inbound email needs a sender address': {
        'es': 'un correo entrante necesita una dirección de remitente',
        'fr': "un courrier entrant a besoin d'une adresse d'expéditeur",
        ...
        'ja': '受信メールには差出人のアドレスが必要です',
        'zh': '收到的邮件需要发件人地址',
        'hi': 'आने वाले ईमेल के लिए भेजने वाले का पता चाहिए',
        'ar': 'يحتاج البريد الوارد إلى عنوان مرسل',
    },
    'an inbound email needs a body': {
        'es': 'un correo entrante necesita un cuerpo',
        'fr': "un courrier entrant a besoin d'un corps",
        'de': 'eine eingehende E-Mail braucht einen Text',
        ...
        'ar': 'يحتاج البريد الوارد إلى نص',
    },
    'only an inbound message can be answered': {
        'es': 'solo se puede responder a un mensaje entrante',
        'fr': 'seul un message entrant peut recevoir une réponse',
        'de': 'nur eine eingehende Nachricht kann beantwortet werden',
        'pt': 'só uma mensagem recebida pode ser respondida',
        'it': 'solo un messaggio in arrivo può ricevere risposta',
        'ja': '返信できるのは受信メッセージだけです',
        'zh': '只能回复收到的消息',
        'hi': 'केवल आए हुए संदेश का उत्तर दिया जा सकता है',
        'ar': 'لا يمكن الرد إلا على رسالة واردة',
    },
    'an outbound email needs a recipient address': {
        'es': 'un correo saliente necesita una dirección de destinatario',
        'fr': "un courrier sortant a besoin d'une adresse de destinataire",
        'de': 'eine ausgehende E-Mail braucht eine Empfängeradresse',
        'pt': 'um e-mail enviado precisa de um endereço de destinatário',
        'it': "un'email in uscita ha bisogno di un indirizzo destinatario",
        'ja': '送信メールには宛先のアドレスが必要です',
        'zh': '发出的邮件需要收件人地址',
        'hi': 'भेजे जाने वाले ईमेल के लिए प्राप्तकर्ता का पता चाहिए',
        'ar': 'يحتاج البريد الصادر إلى عنوان مستلم',
    },
    'an outbound email needs an objective': {
        'es': 'un correo saliente necesita un objetivo',
        'fr': "un courrier sortant a besoin d'un objectif",
        'de': 'eine ausgehende E-Mail braucht ein Ziel',
        'pt': 'um e-mail enviado precisa de um objetivo',
        'it': "un'email in uscita ha bisogno di un obiettivo",
        'ja': '送信メールには目的が必要です',
        'zh': '发出的邮件需要一个目的',
        'hi': 'भेजे जाने वाले ईमेल के लिए एक उद्देश्य चाहिए',
        'ar': 'يحتاج البريد الصادر إلى هدف',
    },
    'this message is not a draft awaiting moderation': {
        ...
        'de': 'diese Nachricht ist kein Entwurf, der auf Moderation wartet',
        ...
        'zh': '这条消息不是等待审核的草稿',
        'hi': 'यह संदेश मॉडरेशन की प्रतीक्षा में कोई मसौदा नहीं है',
        'ar': 'هذه الرسالة ليست مسودة بانتظار المراجعة',
    },
    'an edited reply needs a body': {
        'es': 'una respuesta editada necesita un cuerpo',
        'fr': "une réponse modifiée a besoin d'un corps",
        'de': 'eine bearbeitete Antwort braucht einen Text',
    ...
    'a moderation action is approve, edit, or discard': {
        ...
        'it': "un'azione di moderazione è approva, modifica o scarta",
        'ja': 'モデレーションの操作は承認・編集・破棄のいずれかです',
        'zh': '审核操作只能是批准、编辑或丢弃',
        'hi': 'मॉडरेशन की कार्रवाई स्वीकृत, संपादित या हटाना है',
        'ar': 'إجراء المراجعة هو الموافقة أو التعديل أو التجاهل',
    },
    'that draft belongs to no profile this account holds': {
        'es': 'ese borrador no pertenece a ningún perfil de esta cuenta',
        'fr': "ce brouillon n'appartient à aucun profil de ce compte",
        'de': 'dieser Entwurf gehört zu keinem Profil dieses Kontos',
        'pt': 'esse rascunho não pertence a nenhum perfil desta conta',
        'it': 'quella bozza non appartiene a nessun profilo di questo account',
        'ja': 'その下書きはこのアカウントが保有するプロフィールのものではありません',
        'zh': '该草稿不属于此账户持有的任何形象',
        'hi': 'वह मसौदा इस खाते के किसी प्रोफ़ाइल का नहीं है',
        'ar': 'هذه المسودة لا تخص أي ملف يحتفظ به هذا الحساب',
    },
...
_FIELD_LABELS: dict[str, dict[str, str]] = {
    # The mailbox's two typed fields (qrme/routers/mailbox.py), worded as
