...
DOORS: tuple[Door, ...] = (
    ...
    Door("Trade", "the line under a profile's name",
         "what a profile does for a living, and in which field",
         ("what do they do", "their job", "their profession",
          "job title", "what field", "what line of work")),
