...
## The specification, mined (`qrme/composite.py`, `qrme/simulation.py`, `qrme/campaigns.py`)

The filed specification of App. 19/056,418 describes three capabilities the
claims tables above did not cover; each is implemented from its own words
(tests in `tests/test_spec_mined.py`):
